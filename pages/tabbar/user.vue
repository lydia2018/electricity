<template>  
    <view class="app">  
		...
		<view class="option-wrap">
			...
			<mix-list-cell icon="icon-tuanduiguanli" iconColor="#5fcda2" title="我的分销" @onClick="navTo('/pages/distribution/index', {login: true})"></mix-list-cell>
			<mix-list-cell icon="icon-dizhi" iconColor="#ee883b" title="地址管理" @onClick="navTo('/pages/address/list', {login: true})"></mix-list-cell>
