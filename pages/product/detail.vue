<template>
	<view class="app">
		<pageHeader ref="pageHeader" :isShare="isShare"></pageHeader>
		<!-- 轮播图 -->
		...
		<view class="share-wrap row">
			...
			<!-- #endif -->
			<!-- #ifdef APP-PLUS -->
			<view v-if="mpWxOrgId" class="btn" @click="doAppShare">
				立即分享
				<text class="mix-icon icon-you"></text>
			</view>
			<!-- #endif -->
